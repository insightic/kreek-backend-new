...
app.post('/newSmartContract', async (req, res) => {
    const result = await db_smartcontract.newSmartContract(req.body.smartContractId, req.body.srcCode, req.body.projectName, req.body.projectType, req.body.overallCodeQuality, req.body.explanation, req.body.securityAnalysis);
    res.send(result);
})
...
app.post('/getSourceCode', async (req, res) => {
